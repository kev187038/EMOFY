...
kubectl delete -f ./emotion_classification/serving/k8/service-reader-role.yaml
kubectl delete -f ./emotion_classification/serving/k8/service-reader-rolebinding.yaml